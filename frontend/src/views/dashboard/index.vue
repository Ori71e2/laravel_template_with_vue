<template>
  <div id="dashboard-container" class="dashboard-container">
    ...
    <el-row :gutter="10">
      <el-col :span="12">
        <el-card id="introduction" class="box-card">
      ...
      <el-col :span="12">
        <el-card class="box-card">
          ...
          <p class="desc">本人长期从事有偿教学培训，如果你想系统的学习web程序开发、微信开发和webapp的开发，
    ...
    <el-row :gutter="10">
      <el-col :span="12">
        <el-card ref="log" class="box-card">
          <div slot="header" class="clearfix">
            <span>系统日志</span>
          </div>
      ...
      <el-col :span="12">
        <el-card class="box-card">
          ...
          <div id="sponsor">
            <el-tag v-for="item in sponsor" :key="item" v-html="item" />
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      '王小涛', 'A.T.', '枫叶', '刘洋', '天空的颜色', 'ComeZc',
       'LGY', '记得叫我拿快递', 'tiger', '找不着北', '孔华伟', 'Tim', 'splider']
    }
  },
  computed: {
    ...mapGetters([
  ...
  methods: {
    ...
    adjustDom() {
      const doms = document.documentElement.querySelectorAll('.el-card__body')
      for (let i = 0, len = doms.length; i < len; i++) {
         doms[i].style.cssText = 'padding-top: 0;'
      }
      const other = document.documentElement.querySelectorAll('.el-card__header')
